...
describe('genIntroScene', () => {
  ...
  it('is a Scene subclass that navigates via injected goto and shows the title', () => {
    ...
    expect(s).toContain("goto?.('game')");   // advances to the game scene via injected goto
    expect(s).not.toContain('onStart');
  });
